...
def bias_calc(applied_bias, n_2D):
    ...
    return {
        ...
        "col_barrier": 1.2 * consts.e_c - applied_bias/20 * consts.e_c - applied_bias/10 * consts.e_c,  # Example calculation
        "col_reg3": - applied_bias/20 * consts.e_c - applied_bias/10 * consts.e_c - applied_bias/20 * consts.e_c  # Example calculation,
    }